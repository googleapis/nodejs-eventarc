...
export class EventarcClient {
  ...
  initialize() {
    ...
    const eventarcStubMethods =
        ['getTrigger', 'listTriggers', 'createTrigger', 'updateTrigger', 'deleteTrigger', 'getChannel', 'listChannels', 'createChannel', 'updateChannel', 'deleteChannel', 'getChannelConnection', 'listChannelConnections', 'createChannelConnection', 'deleteChannelConnection'];
